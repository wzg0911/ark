...
def page_num(sl, n, total=14):
    txt(sl, f"{n}/{total}", SW - Inches(1.2), SH - Inches(0.38),
        Inches(1), Inches(0.25), fs=9, color=C_GRAY, align=PP_ALIGN.RIGHT)
...
def make_cover(prs):
    ...
    # 中间装饰线
    hline(sl, Inches(3), Inches(3.5), Inches(7.33), C_GOLD, Pt(1))

    # 装饰圆点
    for i in range(12):
        ox = Inches(1.0 + i * 1.0)
        oy = Inches(1.0)
        dot = sl.shapes.add_shape(9, ox, oy, Inches(0.04), Inches(0.04))
        dot.fill.solid()
        dot.fill.fore_color.rgb = C_GOLD
        dot.line.fill.background()
        dot.fill.fore_color.brightness = 0.3 * i / 12

    # 主标题
    txt(sl, "元神AI：个人因果模型",
        Inches(0.5), Inches(3.65), Inches(12.33), Inches(1.0),
        fs=44, bold=True, color=C_WHITE, align=PP_ALIGN.CENTER)

    # 副标题
    txt(sl, "让每一次托付都心有灵犀",
        Inches(0.5), Inches(4.65), Inches(12.33), Inches(0.55),
        fs=20, color=C_GRAY, align=PP_ALIGN.CENTER)

    # 底部金句
    txt(sl, "让每个人都有一个比自己更好的自己",
        Inches(0.5), SH - Inches(1.2), Inches(12.33), Inches(0.45),
...
def make_exec_summary(prs):
    ...
    # 标签
    section_tag(sl, "EXEC SUMMARY", Inches(0.5), Inches(0.3))
    ...
    txt(sl, "大模型知道世界，但不知道你的世界",
        ...
        fs=28, bold=True, color=C_WHITE, align=PP_ALIGN.CENTER)
    ...
    for i, (n, l) in enumerate(big_nums):
        ...
        txt(sl, n, nx, Inches(1.75), nw, Inches(0.8),
            fs=48, bold=True, color=C_GOLD, align=PP_ALIGN.CENTER)
...
def make_pain_points(prs):
    ...
    section_tag(sl, "MARKET PAIN", Inches(0.5), Inches(0.3))
    hline(sl, Inches(0.5), Inches(0.72), Inches(12.33), C_LINE, Pt(0.5))

    txt(sl, "市场之痛：双重困境",
        Inches(0.5), Inches(0.85), Inches(12.33), Inches(0.6),
        fs=28, bold=True, color=C_WHITE)
...
def make_orange_sea(prs):
    ...
    section_tag(sl, "ORANGE OCEAN", Inches(0.5), Inches(0.3))
    hline(sl, Inches(0.5), Inches(0.72), Inches(12.33), C_LINE, Pt(0.5))
...
def make_vision_overview(prs):
    ...
    section_tag(sl, "META SOUL VISION", Inches(0.5), Inches(0.3))
    hline(sl, Inches(0.5), Inches(0.72), Inches(12.33), C_LINE, Pt(0.5))
...
def make_tech(prs):
    ...
    section_tag(sl, "TECHNOLOGY", Inches(0.5), Inches(0.3))
    hline(sl, Inches(0.5), Inches(0.72), Inches(12.33), C_LINE, Pt(0.5))
...
def make_flywheel(prs):
    ...
    section_tag(sl, "DATA FLYWHEEL", Inches(0.5), Inches(0.3))
    hline(sl, Inches(0.5), Inches(0.72), Inches(12.33), C_LINE, Pt(0.5))
...
def make_biz_model(prs):
    ...
    section_tag(sl, "BUSINESS MODEL", Inches(0.5), Inches(0.3))
    hline(sl, Inches(0.5), Inches(0.72), Inches(12.33), C_LINE, Pt(0.5))
...
def make_founder(prs):
    ...
    section_tag(sl, "FOUNDER STORY", Inches(0.5), Inches(0.3))
    hline(sl, Inches(0.5), Inches(0.72), Inches(12.33), C_LINE, Pt(0.5))
...
def make_funding(prs):
    ...
    section_tag(sl, "FUNDING", Inches(0.5), Inches(0.3))
    hline(sl, Inches(0.5), Inches(0.72), Inches(12.33), C_LINE, Pt(0.5))

    txt(sl, "融资与用途：种子轮 500万",
        Inches(0.5), Inches(0.85), Inches(12.33), Inches(0.6),
        fs=26, bold=True, color=C_WHITE)
    ...
    for i, (n, l, col) in enumerate(stats):
        ...
        txt(sl, n, sx, Inches(1.72), Inches(3.9), Inches(0.65),
            fs=28, bold=True, color=col, align=PP_ALIGN.CENTER)
    ...
    for i in range(8):
        for j in range(3):
            dot = sl.shapes.add_shape(9,
                Inches(0.5 + i * 1.65), Inches(0.2 + j * 0.25),
                Inches(0.04), Inches(0.04))
            dot.fill.solid()
            dot.fill.fore_color.rgb = C_GOLD
            dot.line.fill.background()
            dot.fill.fore_color.brightness = (i * j) / 24

    txt(sl, "让AI替你干活",
        Inches(0.5), Inches(3.3), Inches(12.33), Inches(0.9),
        fs=42, bold=True, color=C_WHITE, align=PP_ALIGN.CENTER)

    txt(sl, "你为自己而活",
        Inches(0.5), Inches(4.1), Inches(12.33), Inches(0.7),
        fs=34, bold=True, color=C_GOLD, align=PP_ALIGN.CENTER)
